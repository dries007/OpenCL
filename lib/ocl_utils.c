...
cl_platform_id ocl_select_platform(void)
{
    ...
    do {
        ...
        {
            char name[NAME_SIZE];
            ocl_err(clGetPlatformInfo(platforms[i], CL_PLATFORM_NAME, NAME_SIZE, name, NULL));
            char vendor[NAME_SIZE];
            ocl_err(clGetPlatformInfo(platforms[i], CL_PLATFORM_VENDOR, NAME_SIZE, vendor, NULL));
            char version[NAME_SIZE];
            ocl_err(clGetPlatformInfo(platforms[i], CL_PLATFORM_VERSION, NAME_SIZE, version, NULL));
...
cl_device_id ocl_select_device(cl_platform_id platform)
{
    ...
    ocl_err(clGetDeviceIDs(platform, CL_DEVICE_TYPE_ALL, num_devices, devices, NULL));
    ...
    do {
        ...
        {
            char name[NAME_SIZE];
            ocl_err(clGetDeviceInfo(devices[i], CL_DEVICE_NAME, NAME_SIZE, name, NULL));
